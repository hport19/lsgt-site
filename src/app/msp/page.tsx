    ...
    <div className="relative min-h-screen text-neutral-100">
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto max-w-6xl px-4 pb-32 pt-10 md:pb-28 md:pt-14">
          <section data-reveal className="grid gap-6 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_30px_90px_rgba(0,0,0,0.5)] backdrop-blur-xl md:grid-cols-[1.08fr_0.92fr] md:p-9">
            <div>
              ...
              <p className="mt-1 text-xs text-cyan-100/85">
                #1 IT Support MSP + #3 Compliance-ready MSP. Powered by Entra ID, Intune, and Defender. Licensed by Texas DPS for security-related services.
              </p>
          ...
          <section data-analytics-section="msp-education-lead" className="mt-8 grid gap-5 rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl md:grid-cols-[0.92fr_1.08fr] md:p-6">
            <div className="grid gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-100/80">Ready to talk?</p>
                <h2 className="mt-2 text-2xl font-semibold md:text-3xl">Use this page to learn. Use the form when you want a plan.</h2>
                <p className="mt-2 text-sm leading-relaxed text-white/70">
                  The MSP page stays educational with plans, add-ons, and FAQs. If you are ready for follow-up, send the basics and we will reply with a practical next step.
                </p>
              </div>
              <DpsTrustBadge compact />
            </div>
            <LeadForm
              formId="msp-education-form"
              source="msp-education"
              title="Request a Managed IT Follow-Up"
              description="Tell us who to contact and we will help you decide whether Essential, Professional, Enterprise, or a custom scope fits best."
              submitLabel="Request MSP follow-up"
            />
          </section>
