...
export const metadata: Metadata = {
  ...
  description:
    "Get a quick managed IT plan from Lone Star GlobalTech. Fast support, proactive monitoring, security-aware service, and predictable monthly IT help.",
  alternates: {
    canonical: "/msp",
  },
  openGraph: {
    title: "Managed IT Services | GlobalTech",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Managed IT Services | GlobalTech",
      },
    ],
  },
};
